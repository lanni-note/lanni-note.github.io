...
const portfolioData = [
    {
        ...
        historicalPrices:   [66959.03, 71333.08, 74205.38, 70411.29, 66847.51, 68597.12, 74797.52, 75767.8, 77015.02, 80921.79],
        historicalAvgCosts: [67941.44, 68037.23, 69188.37, 69543.09, 69289.03, 69008.55, 69430.22, 70107.75, 70883.96, 71555.05],
        historicalAmounts:  [0.0004167, 0.0008215, 0.001213, 0.001609, 0.002018, 0.002433, 0.002821, 0.003194, 0.003554, 0.003912],
        historicalInvested: [28, 56, 84, 112, 140, 168, 196, 224, 252, 280]
    },
    {
        symbol: 'ETH', name: 'Ethereum',
        historicalPrices:   [1993.78, 2081.02, 2328.51, 2144.63, 2061.05, 2104.28, 2382.3, 2306.59, 2290.77, 2376.22],
        historicalAvgCosts: [1983.95, 2001.64, 2042.68, 2070.53, 2069.47, 2071.52, 2092.81, 2120.07, 2141.62, 2157.92],
        historicalAmounts:  [0.003518, 0.006986, 0.01026, 0.01351, 0.0169, 0.02026, 0.02339, 0.0264, 0.0294, 0.03242],
        historicalInvested: [7, 14, 21, 28, 35, 42, 49, 56, 63, 70]
    },
    {
        symbol: 'SOL', name: 'Solana',
        historicalPrices:   [85.85, 88.52, 94.62, 89.99, 81.05, 79.59, 85.91, 85.68, 84.30, 84.84],
        historicalAvgCosts: [81.35, 83.82, 84.40, 86.61, 87.99, 87.41, 86.89, 86.47, 86.68, 86.52],
        historicalAmounts:  [0.02998, 0.06996, 0.09995, 0.1299, 0.1699, 0.1999, 0.2398, 0.2698, 0.3098, 0.3398],
        historicalInvested: [3, 6, 9, 12, 15, 18, 21, 24, 27, 30]
    },
    {
        symbol: 'SUI', name: 'Sui',
        historicalPrices:   [0.9127, 0.996, 1.0275, 0.9434, 0.8626, 0.8697, 0.9455, 0.9403, 0.9356, 0.9446],
        historicalAvgCosts: [0.87, 0.8864, 0.9063, 0.9357, 0.9395, 0.9312, 0.9355, 0.9355, 0.9391, 0.9386],
        historicalAmounts:  [4.4977, 8.8955, 13.0934, 16.9915, 21.1894, 25.6871, 29.7851, 34.0829, 38.2808, 42.4787],
        historicalInvested: [4, 8, 12, 16, 20, 24, 28, 32, 36, 40]
    }
];
